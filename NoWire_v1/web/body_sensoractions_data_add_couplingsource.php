...
echo '
        <div id="sensAction_addCouplingsource_alert" class="alert alert-info">To select a coupling source, you can simply click on the item in the table.</div>
        <table id="sensAction_addCouplingsource_table" class="table table-hover-color table-condensed tableHeadBack-blue">
            <thead>
                <tr>
                    <th>Access</th>
